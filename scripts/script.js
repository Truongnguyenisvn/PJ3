...
function ans1() {
  ...
  answer.textContent =
    "Step back and observe the situation for a few minutes. Wait to see if a parent arrives. If the animal is in immediate danger or is in the road, remove the baby and bring it to a rescue center.";
}
